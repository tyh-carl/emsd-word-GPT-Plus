...
export const settingPreset = {
  ...
  openaiCompatibleAPIKey: inputSetting('sk-r8wr4BgkqAdiAOGT8GQMGg', 'openaiCompatibleAPIKey'),
  openaiCompatibleBasePath: inputSetting('https://10.16.249.249:9083', 'openaiCompatibleBasePath'),
  ...
  openaiCompatibleModelSelect: selectSetting(
    'Qwen3.5-27B-4bit',
    'openaiCompatibleModel',
    availableModelsForOpenAICompatible,
  ),
  openaiCompatibleTemperature: inputNumSetting(0.1, 'openaiCompatibleTemperature', 'temperature'),
  openaiCompatibleMaxTokens: inputNumSetting(128000, 'openaiCompatibleMaxTokens', 'maxTokens'),
